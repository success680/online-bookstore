...
- User Login Credentials: (success680/success680)
...
insert into users values('success680','success680','success680','Raj','Bihar','1236547089','success680@gmail.com',2);
...
Step 1: Click On File > Import > Git > Projects From Git > Clone Uri > Paste The Repository Url as: ```https://github.com/success680rajraja/onlinebookstore.git```> Select master Branch > Next > Next > Finish.
...
Step 8: The default Username And Password For User Is "success680" And "success680"
